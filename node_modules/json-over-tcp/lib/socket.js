...
var createProtocol = require('./protocol.js').create;
...
exports.connect = function(){
		//net.connect is factory function to return net.socket, execute the function first and pass it to constructor
